                        ...
                        <div title="Authenticating requests" id="toc-item-authenticating-requests"
                            ...
                            <a href="#authenticating-requests"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">Authenticating requests</a>
                                    ...
                                    <div class="expandable">
                        <div title="API" id="toc-item-api"
                             class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-4 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none">
                            <a href="#api"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">API</a>
                                                ...
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#api-POSTapi-decks--deck_id--cards">
                                                    Create a new card
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-api-DELETEapi-decks--deck_id--cards--card_id-">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="Delete a card">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#api-DELETEapi-decks--deck_id--cards--card_id-">
                                                    Delete a card
                                                </a>
                                            </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-api-PATCHapi-decks--deck_id--cards--card_id-">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="Update a card">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#api-PATCHapi-decks--deck_id--cards--card_id-">
                                                    Update a card
                                                </a>
                                            </div>
                                                                                    </div>
...
<p>This API is not authenticated.</p>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://kuro-api.test/api/user"
...
fetch(url, {
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="api-DELETEapi-decks--deck_id-">
                    Delete a deck
                </h2>
            </div>
        </div>
...
fetch(url, {
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="api-GETapi-decks--deck_id--cards">
                    Get all cards of a deck
                </h2>
            </div>
        </div>
...
fetch(url, {
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="api-POSTapi-decks--deck_id--cards">
                    Create a new card
                </h2>
            </div>
        </div>
...
fetch(url, {
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="api-DELETEapi-decks--deck_id--cards--card_id-">
                    Delete a card
                </h2>
            </div>
        </div>
...
fetch(url, {
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="api-PATCHapi-decks--deck_id--cards--card_id-">
                    Update a card
                </h2>
            </div>
        </div>
